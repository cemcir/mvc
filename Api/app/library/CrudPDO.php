...
class CrudPDO
{
    ...
    protected function insert($table, $values, $options = [])
    {
        try {
//             echo "<pre>";
//             print_r($values);
...
//             exit;
    ...
    protected function delete($table, $columns, $values, $fileName = null)
    {
        try {
...
//            exit;
    ...
    protected function read($table, $options = [])
    {
        try {
    ...
    protected function wread($table, $columns, $values, $options = [])
    {
